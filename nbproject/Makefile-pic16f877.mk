...
SOURCEFILES_QUOTED_IF_SPACED=configuration_bits.c interrupts.c main.c system.c user.c i2c.c lcd16.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/user.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/lcd16.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/configuration_bits.p1.d ${OBJECTDIR}/interrupts.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/system.p1.d ${OBJECTDIR}/user.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/lcd16.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/user.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/lcd16.p1

# Source Files
SOURCEFILES=configuration_bits.c interrupts.c main.c system.c user.c i2c.c lcd16.c
...
${OBJECTDIR}/lcd16.p1: lcd16.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lcd16.p1.d 
	@${RM} ${OBJECTDIR}/lcd16.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -Og -maddrqual=ignore -v -mwarn=0 -Wa,-a -DXPRJ_pic16f877=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mosccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/lcd16.p1 lcd16.c 
	@-${MV} ${OBJECTDIR}/lcd16.d ${OBJECTDIR}/lcd16.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/lcd16.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
