...
# 6 "kline_time_functions.c" 2


# 1 "./cristal.h" 1
# 9 "kline_time_functions.c" 2
# 1 "./kline_struct.h" 1
# 11 "./kline_struct.h"
# 1 "./ISO.h" 1
# 12 "./kline_struct.h" 2
...
Times ts = { .t_idle = (unsigned char) 1000, .t_init_kline_low = 50, .t_wup_remain = 25 };
